...
import ApplyEffectScreen from '../screens/ApplyEffectScreen/ApplyEffectScreen'
...
const UploadStackNavigator = () => {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="ApplyEffect" component={ApplyEffectScreen} options={{headerShown: false}}/>
